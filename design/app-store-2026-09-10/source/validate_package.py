"""Validate PNG headers/chunks, then package the seven submission images."""
...
expected = {"iphone-6.9": (1320, 2868, 4), "ipad-13": (2064, 2752, 3)}
results = []
...
report = {"date": "2026-09-10", "status": "passed", "file_count": len(results), "files": results}
(root / "validation.json").write_text(json.dumps(report, ensure_ascii=False, indent=2) + "\n")
archive = root / "Scoor-AppStore-ko-KR.zip"
